...
\begin{DoxyCode}
101                                          \{
102     \textcolor{keywordtype}{char}* image\_filename;
103     \textcolor{keywordtype}{char} buffer[4096];
104 
105     \hyperlink{struct__vector}{vector}* cumulative\_image = NULL;
106     \textcolor{keywordflow}{while}(fgets(buffer, \textcolor{keyword}{sizeof}(buffer), stream) != NULL) \{
107         image\_filename = malloc(100);
108         strcpy(image\_filename, buffer);
109         image\_filename[strlen(image\_filename) - 1] = \textcolor{charliteral}{'\(\backslash\)0'};
110         \textcolor{keywordflow}{if}(cumulative\_image == NULL) \{
111             cumulative\_image = \hyperlink{tiff__util_8c_a62e9f072f6cc2973ba744946e6a4c5c3}{tiff\_to\_vec}(image\_filename);
112         \} \textcolor{keywordflow}{else} \{
113             \hyperlink{linalg_8c_adbfad21fe7e851455d625173e67b8504}{vec\_append}(&cumulative\_image, \hyperlink{tiff__util_8c_a62e9f072f6cc2973ba744946e6a4c5c3}{tiff\_to\_vec}(image\_filename));
114         \}
115         free(image\_filename);
116     \}
117     \textcolor{keywordflow}{return} cumulative\_image;
118 \}\end{DoxyCode}
