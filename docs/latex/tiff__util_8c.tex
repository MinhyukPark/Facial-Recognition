...
F\-I\-L\-E $\ast$ \hyperlink{tiff__util_8c_a20075269ff8a00284dd35725029d4428}{get\-\_\-all\-\_\-tiff} (char $\ast$path, int $\ast$num\-\_\-files)
...
\hyperlink{linalg_8h_a07a01529159cc35e78c1f7731ac7bda6}{vector} $\ast$ \hyperlink{tiff__util_8c_a8f8b0a0f74bb3416dd0214aa0a68130e}{tiff\-\_\-stream\-\_\-to\-\_\-vec} (F\-I\-L\-E $\ast$stream)
...
\hypertarget{tiff__util_8c_a20075269ff8a00284dd35725029d4428}{\index{tiff\-\_\-util.\-c@{tiff\-\_\-util.\-c}!get\-\_\-all\-\_\-tiff@{get\-\_\-all\-\_\-tiff}}
\index{get\-\_\-all\-\_\-tiff@{get\-\_\-all\-\_\-tiff}!tiff_util.c@{tiff\-\_\-util.\-c}}
...
)}}\label{tiff__util_8c_a20075269ff8a00284dd35725029d4428}
...
\begin{DoxyCode}
80                                                \{
81     \textcolor{keywordtype}{char}* command = malloc(strlen(path) + 100);
82     sprintf(command, \textcolor{stringliteral}{"%s%s%s"}, \textcolor{stringliteral}{"find "}, path, \textcolor{stringliteral}{"*.tiff -type f -exec ls \{\} \(\backslash\)\(\backslash\);"});
83      
84     
85     printf(\textcolor{stringliteral}{"%s\(\backslash\)n"}, command);
86     FILE* retval = popen(command, \textcolor{stringliteral}{"r"});
87 
88     sprintf(command, \textcolor{stringliteral}{"%s%s%s"}, \textcolor{stringliteral}{"find "}, path, \textcolor{stringliteral}{"*.tiff -type f -exec ls \{\} \(\backslash\)\(\backslash\); | wc -l"});
89     
90     printf(\textcolor{stringliteral}{"%s\(\backslash\)n"}, command);
91     FILE* num\_files\_fp = popen(command, \textcolor{stringliteral}{"r"});
92     \textcolor{keywordflow}{if}(fgets(command, \textcolor{keyword}{sizeof}(command), num\_files\_fp) != NULL) \{
93         *num\_files = atoi(command);
94     \}
95     pclose(num\_files\_fp);
96     free(command);
97     \textcolor{keywordflow}{return} retval;
98 \}
\end{DoxyCode}
\hypertarget{tiff__util_8c_a8f8b0a0f74bb3416dd0214aa0a68130e}{\index{tiff\-\_\-util.\-c@{tiff\-\_\-util.\-c}!tiff\-\_\-stream\-\_\-to\-\_\-vec@{tiff\-\_\-stream\-\_\-to\-\_\-vec}}
\index{tiff\-\_\-stream\-\_\-to\-\_\-vec@{tiff\-\_\-stream\-\_\-to\-\_\-vec}!tiff_util.c@{tiff\-\_\-util.\-c}}
...
\end{DoxyParamCaption}
)}}\label{tiff__util_8c_a8f8b0a0f74bb3416dd0214aa0a68130e}
...
\begin{DoxyCode}
100                                          \{
101     \textcolor{keywordtype}{char}* image\_filename;
102     \textcolor{keywordtype}{char} buffer[4096];
103 
104     \hyperlink{struct__vector}{vector}* cumulative\_image = NULL;
105     \textcolor{keywordflow}{while}(fgets(buffer, \textcolor{keyword}{sizeof}(buffer), stream) != NULL) \{
106         image\_filename = malloc(100);
107         strcpy(image\_filename, buffer);
108         image\_filename[strlen(image\_filename) - 1] = \textcolor{charliteral}{'\(\backslash\)0'};
109         \textcolor{keywordflow}{if}(cumulative\_image == NULL) \{
110             cumulative\_image = \hyperlink{tiff__util_8c_a62e9f072f6cc2973ba744946e6a4c5c3}{tiff\_to\_vec}(image\_filename);
111         \} \textcolor{keywordflow}{else} \{
112             \hyperlink{linalg_8c_adbfad21fe7e851455d625173e67b8504}{vec\_append}(&cumulative\_image, \hyperlink{tiff__util_8c_a62e9f072f6cc2973ba744946e6a4c5c3}{tiff\_to\_vec}(image\_filename));
113         \}
114         free(image\_filename);
115     \}
116     \textcolor{keywordflow}{return} cumulative\_image;
117 \}\end{DoxyCode}
