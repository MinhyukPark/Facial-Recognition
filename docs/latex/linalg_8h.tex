...
double \hyperlink{linalg_8h_abb2106d12022de4436ca036630b72c4a}{dot\-\_\-product} (const double $\ast$x, const double $\ast$y, int length)
...
\hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$ \hyperlink{linalg_8h_aa4d1ecd27c0286ae773d5e5e605d2863}{matmat\-\_\-multiply} (const \hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$mat\-\_\-a, const \hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$mat\-\_\-b)
...
\hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$ \hyperlink{linalg_8h_a5782414af0ece77ec1b4b6071f044c4c}{matmat\-\_\-addition} (const \hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$mat\-\_\-a, const \hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$mat\-\_\-b)
...
\hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$ \hyperlink{linalg_8h_ace47b4b7b9d69c2be193b1c1bbeda858}{matmat\-\_\-subtraction} (const \hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$mat\-\_\-a, const \hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$mat\-\_\-b)
...
\hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$ \hyperlink{linalg_8h_a54995af371f3afdcd869e425e59dab2a}{matscalar\-\_\-multiply} (const \hyperlink{linalg_8h_abc75382643898dd572498a574bf891c7}{matrix} $\ast$mat\-\_\-a, const double scalar)
...
373 \}
\end{DoxyCode}
\hypertarget{linalg_8h_abb2106d12022de4436ca036630b72c4a}{\index{linalg.\-h@{linalg.\-h}!dot\-\_\-product@{dot\-\_\-product}}
...
\item[{int}]{length}
\end{DoxyParamCaption}
)}}\label{linalg_8h_abb2106d12022de4436ca036630b72c4a}
...
194 \}
\end{DoxyCode}
\hypertarget{linalg_8h_a5782414af0ece77ec1b4b6071f044c4c}{\index{linalg.\-h@{linalg.\-h}!matmat\-\_\-addition@{matmat\-\_\-addition}}
...
\end{DoxyParamCaption}
)}}\label{linalg_8h_a5782414af0ece77ec1b4b6071f044c4c}
...
\begin{DoxyCode}
128 \{
129     \hyperlink{struct__matrix}{matrix} *retVal = \hyperlink{linalg_8c_a7821976cc30bc3131f3646bec1992d91}{matrix\_create}(matA->row, matB->col);
130     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < matA->row; i++)
131     \{
132         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} j = 0; j < matB->col; j++)
133         \{
...
138 \}
\end{DoxyCode}
\hypertarget{linalg_8h_aa4d1ecd27c0286ae773d5e5e605d2863}{\index{linalg.\-h@{linalg.\-h}!matmat\-\_\-multiply@{matmat\-\_\-multiply}}
...
\item[{const {\bf matrix} $\ast$}]{mat\-\_\-b}
\end{DoxyParamCaption}
)}}\label{linalg_8h_aa4d1ecd27c0286ae773d5e5e605d2863}
...
\begin{DoxyCode}
110 \{
111     \hyperlink{struct__matrix}{matrix} *retVal = \hyperlink{linalg_8c_a7821976cc30bc3131f3646bec1992d91}{matrix\_create}(matA->row, matB->col);
112     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t} i =0; i<matA->row;i++)
113     \{
114         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t} j=0; j<matB->col;j++)
115         \{
116             \hyperlink{linalg_8h_ae0e32e641b8137c777d52988864296e3}{MAT}(retVal,i,j) = 0;
117             \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t} k=0; k<matA->col;k++)
118             \{
...
124 \}
\end{DoxyCode}
\hypertarget{linalg_8h_ace47b4b7b9d69c2be193b1c1bbeda858}{\index{linalg.\-h@{linalg.\-h}!matmat\-\_\-subtraction@{matmat\-\_\-subtraction}}
...
\item[{const {\bf matrix} $\ast$}]{mat\-\_\-b}
\end{DoxyParamCaption}
)}}\label{linalg_8h_ace47b4b7b9d69c2be193b1c1bbeda858}
...
\begin{DoxyCode}
142 \{
143     \hyperlink{struct__matrix}{matrix} *retVal = \hyperlink{linalg_8c_a7821976cc30bc3131f3646bec1992d91}{matrix\_create}(matA->row, matB->col);
144     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < matA->row; i++)
145     \{
146         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} j = 0; j < matB->col; j++)
147         \{
...
\begin{DoxyCode}
170 \{
171     \hyperlink{struct__matrix}{matrix} *retVal = \hyperlink{linalg_8c_a7821976cc30bc3131f3646bec1992d91}{matrix\_create}(matA->row, matA->col);
172     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < matA->row; i++)
173     \{
174         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} j = 0; j < matA->col; j++)
175         \{
...
180 \}
\end{DoxyCode}
\hypertarget{linalg_8h_a54995af371f3afdcd869e425e59dab2a}{\index{linalg.\-h@{linalg.\-h}!matscalar\-\_\-multiply@{matscalar\-\_\-multiply}}
...
\item[{const double}]{scalar}
\end{DoxyParamCaption}
)}}\label{linalg_8h_a54995af371f3afdcd869e425e59dab2a}
...
\begin{DoxyCode}
156 \{
157     \hyperlink{struct__matrix}{matrix} *retVal = \hyperlink{linalg_8c_a7821976cc30bc3131f3646bec1992d91}{matrix\_create}(matA->row, matA->col);
158     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < matA->row; i++)
159     \{
160         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} j = 0; j < matA->col; j++)
161         \{
